		...
		<div class="panel-body">
			<form class="form-horizontal" role="form" method="post" action="">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="txtUserName" name="txtUserName" placeholder="[FULL NAME]" required="">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group last">
					<div class="col-sm-offset-3 col-sm-9">
						<button type="submit" class="btn btn-success btn-sm" name="addTechUser">Add Tech User</button>
